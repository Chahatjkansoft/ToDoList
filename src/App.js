  ...
  return (
    <div className="App">
      <Router>
        ...
        <Routes>
          <Route exact path="/" element={[<AddTodo addTodo={addTodo} selectedTodoForUpdate={selectedTodoForUpdate} />,
                                        <Todos ToDoList ={toDoList} onDelete={onDelete}  onUpdate={onUpdate} Done={Done} />]} ></Route>
